...
#define device_on_current_threshold 500
...
#define MySSID2 "Redmin 9" // TODO: Change to your Wifi network SSID
#define MyWifiPassword2 "e256262024" // TODO: Change to your Wifi network password
...
//5dfd846d22a7867b6ceee479 es la ID para CHRISTMAS LIGHT
...
void setup() {
  ...
  webSocket.begin("itsoft-websocket-server.glitch.me", 80, "/"); //"iot.sinric.com", 80
...
void loop() {
  ...
  if(isConnected) {
      ...
      if((now - heartbeatTimestamp) > HEARTBEAT_INTERVAL) {
          ...
          currentMeter();
          if (deviceState == 1) {
            setPowerStateOnServer("5b67b71a6efd767421f28173", "ON");
            Serial.println("Sending device status ON id: 5bf2d58537c3d52b8427d29f");
          }else{
            setPowerStateOnServer("5b67b71a6efd767421f28173", "OFF");
