...
#define device_on_current_threshold 460
...
//5b67b71a6efd767421f28173 ES PARA LA COCINA - JULIO
 
void turnOn(String deviceId) {
  if (deviceId == "5b67b71a6efd767421f28173") // Device ID of first device
  {  
    currentMeter();
    currentMeter();
    ...
    if((deviceState == 0) && (digitalRead(LED_BUILTIN) == 1)){
      ...
      Serial.print("ENTRADA Turn on device id: ");
      Serial.println(deviceId);
  }
...
void turnOff(String deviceId) {
   ...
   {  
    ...
    Serial.print("ENTRADA Turn off device id: ");
    Serial.println(deviceId); 
  }
}
