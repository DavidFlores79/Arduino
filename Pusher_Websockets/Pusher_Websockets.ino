...
//CONFIGURE
#define SSID        "dlink"
#define PASS        "54146aaf13a2cb9b1837b3e260841e3e1dab67fe059e097a6a0875495401a0d6"
#define PUSHER_KEY  "91cfcf7fa849db5bf647"
...
//const char SUBSCRIBE_JSON[] PROGMEM = "{\"event\":\"pusher:subscribe\",\"data\":{\"channel\":\"esp8266-data\"}}";
  ...
  if (!connected) {
    ...
    if (waitForString(getString(STR_SENDMODE), 1, 1000)) {
      ...
      if (waitForString(getString(WS_OK), 2, 1000)) {
        ...
        wssend(getString("{\"event\":\"pusher:subscribe\",\"data\":{\"channel\":\"post.20\"}}"));
        connected = true;
