...
const char GoogleHomeName[] = "Sala de estar";  //Must match the name on Google Home APP

const char *host= "GoogleSay";
String ttstext = "Hola, Google te recuerda que ya van ";
...
void connectToGH(){
  ...
  if (ghn.device(GoogleHomeName, "es") != true) {
    Serial.println(ghn.getLastError());
    return;
  }
...
void setup(void) {
  ...
  String init_text = "Sensores iniciados"; // Goto " + ipToString(WiFi.localIP()) + " on your web browser to make me speak!";
