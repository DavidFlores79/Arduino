...
void turnOn(String deviceId) {
  if (deviceId == "5bfa2c88303590117a1f3559") // Device ID of first device
  {  
    currentMeter();
    currentMeter();
...
void setup() {
  ...
  if(!wifiManager.autoConnect("SmartLight")){
...
void loop() {
  ...
  if(isConnected) {
      ...
      if((now - heartbeatTimestamp) > HEARTBEAT_INTERVAL) {
          ...
          currentMeter();
          if (deviceState == 1) {
            setPowerStateOnServer("5bfa2c88303590117a1f3559", "ON");
            Serial.println("Sending device status ON id: 5bfa2c88303590117a1f3559");
          }else{
            setPowerStateOnServer("5bfa2c88303590117a1f3559", "OFF");
