...
#define MySSID2 "TALLERET" // TODO: Change to your Wifi network SSID
...
void turnOn(String deviceId) {
  if (deviceId == "5b6259a7e4efb94d35aa604c") // Device ID of first device
  {  
    currentMeter();
...
void loop() {
  ...
  if(isConnected) {
      ...
      if((now - heartbeatTimestamp) > HEARTBEAT_INTERVAL) {
          ...
          currentMeter();
          if (deviceState == 1) {
            setPowerStateOnServer("5b6259a7e4efb94d35aa604c", "ON");
            Serial.println("Sending device status ON id: 5bf2d58537c3d52b8427d29f");
          }else{
            setPowerStateOnServer("5b6259a7e4efb94d35aa604c", "OFF");
